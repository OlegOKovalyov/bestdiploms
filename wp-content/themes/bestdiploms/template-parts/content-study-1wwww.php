...
<?php $attachments = get_attached_media( 'image', 745 ); /*echo '<pre>'; var_dump($attachments); echo '</pre>'*/ 
...
<!-- <a href="<?php //echo get_the_post_thumbnail_url( $post->ID, array(580,408) ); ?>" data-fancybox="images" data-caption="<?php //the_title() ?>"> -->
<?php print_r($gal_url); ?>
<!-- <a href="http://wpbestdiploms.loc/wp-content/uploads/2018/04/DSC03015-672x372.jpg" data-fancybox="images" data-caption="<?php //the_title() ?>"> -->
