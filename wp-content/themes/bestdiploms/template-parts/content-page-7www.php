		...
		<div class="entry-content col-lg-9">
			...
			<h1><?php the_title() ?></h1>
					    ...
					    <?php 
					        ...
					        $post_id = $post->ID; echo '$post_id= ' . $post_id . ' ';
					        $wp_post_parent_id = wp_get_post_parent_id( $post_id ); echo 'wp_post_parent_id= ' . $wp_post_parent_id;
						...
						<div class="price-item">
					        ...
					        if ( $your_in_loop->have_posts() ) : while ( $your_in_loop->have_posts() ) : $your_in_loop->the_post(); ?>					        <?php $post_in_id = $post->ID; echo '<br>$post_in_id= ' . $post_in_id; ?>
					        ...
					        <?php /*while ( $post_id == $post->ID ) :*/ /*do {*/
					            ...
					            if( $value || $value2 ) { ?>
									<section>
									    ...
									    <span class="price-props">
									        <p class="price-item-title"><?php the_title(); ?> <span class="price-item-year"> <?php echo $value1; ?></span></p>
